...
{
public:
    MessageBoxPopup(short x, short y, short width, Border *border, Color color, Color backgroundColor, std::string message, Button *actionBtn = nullptr) : Panel(x + 5, y + 5, border, color, backgroundColor),
    ...
    void setActionButton(Button *button) { this->actionBtn = button; };
